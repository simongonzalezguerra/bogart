...
Application::Application()
{
	...
	// _ry: how many degrees to rotate along the Y axis relative to the current orientation. Used to look left and right. Positive values turn left
	// _rx: how many degrees to rotate along the X axis relative to the current orientation. Used to look up and down. Positive values look up
...
{
	cout << "mouseMoveEvent, dX = " << dX << ", dY = " << dY << "\n";
